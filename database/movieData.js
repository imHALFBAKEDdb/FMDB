module.exports = [
  {
    ...
    review_average: 5,
    review_count: 667,
    extra_images: "https://gifer.com/i/3hmW.gif",
...
// var updated = (input, callback) => {
//   input.forEach(elem => {
//     elem["Poster"] =
//       "https://m.media-amazon.com/images/M/MV5BM2MyNjYxNmUtYTAwNi00MTYxLWJmNWYtYzZlODY3ZTk3OTFlXkEyXkFqcGdeQXVyNzkwMjQ5NzM@._V1_UY268_CR3,0,182,268_AL_.jpg";
//     elem["extra_images"] = "https://gifer.com/i/3hmW.gif";
//   });
//   callback(input);
// };

// var fs = require("fs");
// // var fileContent = JSON.stringify(updated);

// addIndex(module.exports, data => {
//   console.log(data);
